							...
							<table>
								...
								<?php
									if (!empty($_REQUEST['term'])) {
										...
										($lidhe,$_REQUEST['term']);  
										$sql= mysqli_query ($lidhe3, "CALL umseZgjedhterm_perdorues('$term')");   
										while($rreshti = mysqli_fetch_array($sql)) { 		
											echo "<tr>";
												echo "<td>".$rreshti['Emri']."</td>";
												echo "<td>".$rreshti['Fjalekalimi']."</td>";
												echo "<td>".$rreshti['Email']."</td>";	
												echo "<td><a href=\"fshij_perdoruesin.php?ID_p=$rreshti[ID_p]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\"  class='button primary'>Fshije</a></td>
											</tr>";	
										}
									}
								?>								
